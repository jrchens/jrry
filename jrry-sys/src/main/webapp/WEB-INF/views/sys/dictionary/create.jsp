...
<form:form id="sys_dictionary_create_form" method="post"
           modelAttribute="dictionary" cssStyle="padding: 5px; margin: 0px;"
           cssClass="easyui-panel" title="字典管理-新增"
           data-options="inline: true" action="${pageContext.request.contextPath}/sys/dictionary/save">
...
<c:if test="${not empty dictionary.parentCode }">
        ...
        <tr>
            <td>禁用</td>
            <td><span class="easyui-switchbutton" data-options="onChange:function(checked){
            ...
            <td><form:input path="srt" cssClass="easyui-numberbox"
                            data-options="min:1,required:true,fit:true,value:1"/><form:errors
                    path="srt"/></td>
        </tr>
