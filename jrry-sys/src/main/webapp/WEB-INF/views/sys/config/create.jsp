...
<form:form id="sys_config_create_form" method="post"
           modelAttribute="config" cssStyle="padding: 5px; margin: 0px;"
           cssClass="easyui-panel" title="配置管理-新增"
           data-options="inline: true" action="${pageContext.request.contextPath}/sys/config/save">
        ...
        <tr>
            <td colspan="4">
                <a href="javascript:;" class="easyui-linkbutton" data-options="iconCls: 'ext-icon fa fa-floppy-o ', width: 80,
                        ...
                        var form = $('#sys_config_create_form');
                        form.submit();
                        }">保存</a>
