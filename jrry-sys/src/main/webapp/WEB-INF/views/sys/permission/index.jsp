...
<form:form id="sys_permission_query_form" method="post"
    ...
    <table class="ext-data-table" style="width: 100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>类别</td>
            <td><form:input path="category" cssClass="easyui-combobox" data-options="fit:true,url:'${pageContext.request.contextPath}/resources/js/permission_category_data.json',method:'get',groupField:'group',groupField:'group'"></form:input></td>
            <td>显示名</td>
