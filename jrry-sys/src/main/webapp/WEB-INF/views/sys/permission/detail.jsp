    ...
    <table class="ext-data-table">
        ...
        <tr>
            ...
            <td><form:input path="category" cssClass="easyui-combobox"
                            data-options="required:true,fit:true,url:'${pageContext.request.contextPath}/resources/js/permission_category_data.json',method:'get',groupField:'group',groupField:'group',readonly:true"/><form:errors
                    path="category"/></td>
            <td>显示名</td>
