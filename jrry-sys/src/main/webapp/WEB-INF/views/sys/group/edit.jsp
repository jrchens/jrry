...
<form:form id="sys_group_edit_form" method="post"
           modelAttribute="group" cssStyle="padding: 5px; margin: 0px;"
           cssClass="easyui-panel" title="群组管理-编辑"
           data-options="inline: true" action="${pageContext.request.contextPath}/sys/group/update">
    <form:hidden path="id"/>
