...
//		// int OPT = 0X01;
//		// String DATA = "收费200元";
//		// byte[] DATA_ARRAY = DATA.getBytes("GB2312");
//		// DL += DATA.length();
//
//		String DATA = "收费200元";
//		int DL = 1;
//		DL += length(DATA);
//
//		StringBuffer buffer = new StringBuffer("0064FFFF30");
//		buffer.append(String.format("%02X", DL)).append("01");
//		buffer.append(Hex.encodeHexString(DATA.getBytes("GB2312")).toUpperCase());
//
//		System.out.println(buffer);
//
//		byte[] DATA_ARRAY = Hex.decodeHex(buffer.toString().toCharArray());
//
//		CRC16 crc = new CRC16();
//		crc.update(DATA_ARRAY, 0, DATA_ARRAY.length);
//		byte[] b = ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putInt(crc.getValue()).array();
////		byte[] b = Ints.toByteArray((int)crc.getValue());
//		for (byte c : Arrays.copyOfRange(b, 0, 2)) {
//			buffer.append(String.format("%02X", c));
//		}
//
//		// 00 64 FF FF 30 0A 01 CA D5 B7 D1 32 30 30 D4 AA 9E BF
//		// 064FFFF30A1CAD5B7D1323030D4AA98BD
//		System.out.println(buffer);
//		System.out.println("0064FFFF300A01CAD5B7D1323030D4AA9EBF");
//
//	}
